...
# License: GPLv3
# 
# Refactored by Cyber-Syntax for its own problem solving purposes
# 
# Solution for: ERROR: The control display is undefined; please run `nvidia-settings --help` for usage information.
export DISPLAY=":0"
# Solution for: Authorization required, but no authorization protocol specified
